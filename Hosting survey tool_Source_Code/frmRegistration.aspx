...
<center>&nbsp;</center>
   ...
   <td>
        ...
        ErrorMessage="*" ValidationGroup="vg1" ></asp:RequiredFieldValidator></td><td align="left"><span class="style8">
                ...
                ValidationGroup="vg1" ontextchanged="txtPassword_TextChanged"  ></asp:TextBox>
                                                       ...
                                                       <td>
                                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                                               ControlToValidate="txtPassword" ErrorMessage="*" ValidationGroup="vg1"></asp:RequiredFieldValidator>
            </td>
        </tr>
        ...
        ErrorMessage="*" ValidationGroup="vg1" ></asp:RequiredFieldValidator>
                ...
                <td>
                    <asp:TextBox ID="txtDOB" onfocusout="calage()" runat="server" 
        ...
        ErrorMessage="*" ValidationGroup="vg1" ></asp:RequiredFieldValidator>
                    <asp:CompareValidator ID="cv2" runat="server" ControlToValidate="txtDOB" 
                        ErrorMessage="*" Operator="DataTypeCheck" Type="Date" ValidationGroup="vg1"></asp:CompareValidator>
                </td>
            </tr>
            <tr>
                <td class="style8">
                ...
                <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine"></asp:TextBox>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                            ControlToValidate="txtAddress" ErrorMessage="*" ValidationGroup="vg1"></asp:RequiredFieldValidator>
                                        </td>
                </tr>
               <tr>
                <td colspan="6">
        ...
        <td><asp:Button ID="btnSubmit" runat ="server" Text ="Submit" 
            ...
            <asp:Button ID="btnClear" runat ="server" 
                Text ="Clear" OnClientClick="clearForm(this.form);" 
   ...
   <td>
        ...
        <asp:Label ID="lblMessage" runat="server" Text="lblMessage" Visible="false" 
            style="font-family: Verdana; color: #FFFFFF"></asp:Label>
