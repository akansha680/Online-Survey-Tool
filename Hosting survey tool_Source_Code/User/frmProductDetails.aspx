<%@ Page Language="C#" MasterPageFile="~/User/UserMasterPage.master" AutoEventWireup="true" CodeFile="frmProductDetails.aspx.cs" Inherits="User_frmProductDetails" Title="Untitled Page" %>
    ...
    <center>
        <table style="width: 702px; height: 304px;">
            ...
            <tr>
                ...
                <td class="style9">
                    <strong><span style="color:#ECE9D8">View Products By Category&gt;&gt;</span></strong></td>
                <td style="width: 268px; height: 16px; text-align:center">
                    <asp:DropDownList ID="ddlProductType" runat="server"  Width="153px" 
                        AutoPostBack="True" onselectedindexchanged="ddlStockType_SelectedIndexChanged">
                    </asp:DropDownList></td>
